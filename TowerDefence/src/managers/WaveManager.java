...
public class WaveManager {
    ...
    private int waveTickLimit = 60 * 2;
    ...
    public void update() {
        ...
        if (waveStartTimer) {
            waveTick++;
            if (waveTick >= waveTickLimit) waveTickTimerOver = true;
        }
    }
    ...
    public boolean isWaveTimerOver() { return waveTickTimerOver; }
    public void startWaveTimer() { waveStartTimer = true; }
    ...
    public boolean isTimeForNewEnemy() { return enemySpawnTick >= enemySpawnTickLimit; }
    public boolean isThereMoreEnemiesInWave() { return enemyIndex < waves.get(waveIndex).getEnemyList().size(); }
    public boolean isThereMoreWaves() { return waveIndex + 1 < waves.size(); }
    public void resetEnemyIndex() { enemyIndex = 0; }
    public int getWaveIndex() { return waveIndex; }
    public boolean isWaveTimerStarted() { return waveStartTimer; }
